package com.joaodev.marketplace.registration.infrastructure;
...
@EnableJpaRepositories(
        basePackages = "com.joaodev.marketplace.registration",
...
public class RegistrationConfiguration {
    ...
    @Primary
    @Bean
    @ConfigurationProperties("registration.configuration")
    public HikariDataSource registrationDatSource(DataSourceProperties properties) {
    ...
    public LocalContainerEntityManagerFactoryBean registrationEntityManagerFactory(DataSource dataSource,
        ...
        return builder
                ...
                .packages("com.joaodev.marketplace.registration")
